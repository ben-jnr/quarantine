...
function Institution(props)
{
    ...
    const InstitutionsListGenerate = () => {
        var url = "http://www.ccctsr.in/api/institution?taluk="+taluk+ "&village="+village + 
    ...
    const removeInstitution = (id) =>{
        ...
        {
            var url = "http://www.ccctsr.in/api/institution/delete/"+id+"?id="+window.localStorage.getItem('session')
            axios.get(url)
                .catch(err => console.log(err));
        }  
    ...
    const handleSubmit = (e) =>{
        ...
        {    
            ...
            var url = "http://www.ccctsr.in/api/institution/add?id="+ window.localStorage.getItem('session');
            axios
